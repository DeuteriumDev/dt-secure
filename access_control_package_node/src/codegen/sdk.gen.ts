...
export const accessControlEnvironmentsList = <ThrowOnError extends boolean = false>(options?: Options<AccessControlEnvironmentsListData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<AccessControlEnvironmentsListResponses, unknown, ThrowOnError>({
        url: '/api/v1/access-control/environments/',
        ...options
    });
};

export const accessControlEnvironmentsCreate = <ThrowOnError extends boolean = false>(options: Options<AccessControlEnvironmentsCreateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<AccessControlEnvironmentsCreateResponses, unknown, ThrowOnError>({
        url: '/api/v1/access-control/environments/',
        ...options,
        headers: {
...
export const accessControlEnvironmentsDestroy = <ThrowOnError extends boolean = false>(options: Options<AccessControlEnvironmentsDestroyData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<AccessControlEnvironmentsDestroyResponses, unknown, ThrowOnError>({
        url: '/api/v1/access-control/environments/{id}/',
        ...options
    });
};

export const accessControlEnvironmentsRetrieve = <ThrowOnError extends boolean = false>(options: Options<AccessControlEnvironmentsRetrieveData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<AccessControlEnvironmentsRetrieveResponses, unknown, ThrowOnError>({
        url: '/api/v1/access-control/environments/{id}/',
        ...options
    });
};

export const accessControlEnvironmentsPartialUpdate = <ThrowOnError extends boolean = false>(options: Options<AccessControlEnvironmentsPartialUpdateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<AccessControlEnvironmentsPartialUpdateResponses, unknown, ThrowOnError>({
        url: '/api/v1/access-control/environments/{id}/',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
export const accessControlEnvironmentsUpdate = <ThrowOnError extends boolean = false>(options: Options<AccessControlEnvironmentsUpdateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<AccessControlEnvironmentsUpdateResponses, unknown, ThrowOnError>({
        url: '/api/v1/access-control/environments/{id}/',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
export const accessControlUsersWithGroupCreate = <ThrowOnError extends boolean = false>(options: Options<AccessControlUsersWithGroupCreateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<AccessControlUsersWithGroupCreateResponses, unknown, ThrowOnError>({
